      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-primary-400 mb-4">AUSY EXPO</h3>
            <p className="text-gray-300 mb-4">
              Leading garment export company providing high-quality textile products 
              and comprehensive export solutions to clients worldwide.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>📧 info@ausyexpo.com</p>
              <p>📞 +1 (555) 123-4567</p>
              <p>📍 123 Export Street, Trade City, TC 12345</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-center text-gray-400">
            © 2024 AUSY EXPO. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
